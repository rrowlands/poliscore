...
if [ "$1" == "1" ]; then
  ...
  sed -i '' 's|ipgeolocation02363461-ojkx6KmXVj1V|Poliscore1ipgeolocation683E-N4epMkZ8yjtM|g' ./webapp/src/main/java/us/poliscore/service/SecretService.java
...
if [ "$1" == "2" ]; then
  ...
  sed -i '' 's|Poliscore1ipgeolocation683E-N4epMkZ8yjtM|ipgeolocation02363461-ojkx6KmXVj1V|g' ./webapp/src/main/java/us/poliscore/service/SecretService.java
