...
//			  
//			  if (prev != null && prev.length() + cur.length() >= OpenAIService.MAX_REQUEST_LENGTH)
//			  {
//				  sections.add(prev.toString());
//				  prev = null;
//			  }
//			  if (cur.length() >= OpenAIService.MAX_REQUEST_LENGTH)
//			  {
...
//					  }
//				  }
//				  else if (cur.length() + line.length() >= OpenAIService.MAX_REQUEST_LENGTH)
//				  {
//					  sections.add(cur.toString());
//					  cur = new StringBuilder();
//				  }
